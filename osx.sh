...
sudo scutil --set ComputerName "James Nettik's MBP"
sudo scutil --set HostName "James Nettik's MBP"
sudo scutil --set LocalHostName "jnettik-mbp"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "James Nettik's MBP"
