...
sudo scutil --set ComputerName "James' MBP"
sudo scutil --set HostName "James' MBP"
sudo scutil --set LocalHostName "jnettik-mbp"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "James' MBP"
